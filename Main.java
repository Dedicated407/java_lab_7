...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(states.get(3)); //вывод по индексу
        ...
        if(states.contains("Германия")){ //проверка на наличие элемента в коллекции
        ...
        Object[] countries = states.toArray();//преобразование списка в массив объектов
